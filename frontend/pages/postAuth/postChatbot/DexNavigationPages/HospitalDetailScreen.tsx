    ...
    <View style={styles.mapContainer}>
      ...
      <View style={styles.locationContainer}>
        <Text style={styles.locationText}>
          401 3rd St, San Francisco <CopyIcon style={styles.copyIcon} />{" "}
        </Text>
        <View style={styles.locationIconContainer}></View>
      </View>
    </View>
  );
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      <ScrollView style={styles.container}>
        <Image
          source={Hospital6} // Use actual image from assets
        ...
        <View style={styles.infoContainer}>
          ...
          <View
            style={[styles.dividerLine, { marginBottom: 13, marginTop: 13 }]}
          />

          <Text style={styles.distance}>
            <DistanceIcon style={{ marginRight: 10 }} />
            0.7 mi
            <Text style={styles.address}> • 401 3rd St, San Francisco</Text>
          </Text>
          <Text style={styles.availability}>
            <TimeIcon style={{ marginRight: 10, marginBottom: -4 }} />
            Open now{" "}
            <Text style={styles.timeOpenText}>• Today 8 AM - 4:30 PM</Text>
          </Text>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.weekHoursContainer}>
            ...
            <View style={styles.rowContainer}>
              ...
              <View style={styles.dayContainer}>
                <Text
                  style={{ color: "#367CDD", paddingBottom: 8, paddingTop: 2 }}
                >
                  Saturday
                </Text>
        ...
        <View style={styles.aboutUsContainer}>
          ...
          <View style={styles.aboutUsContentContainer}>
            <Text style={styles.aboutUsText}>
              At San Francisco VA Health Care System, our mission is to honor
              Veterans, their families, and caregivers by offering exceptional
              care that improves their health and well-being.
              {"\n\n"}
              With an unparalleled reputation as providers of the most complex
              care across VHA, we have a long-history of conducting cutting-edge
              research, establishing innovative medical programs, and providing
              compassionate care. Notably, for over 60 years, the Medical
              Center's affiliation with the University of California, San
              Francisco (UCSF) ensures that all physicians are jointly recruited
